...
QBShared.Weapons = {
	...
	--mod
	-- [`weapon_vlr_vandal`]          = { name = 'weapon_vlr_vandal', label = 'VLR Vandal', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
	-- [`weapon_longden`]                   = { name = 'weapon_longden', label = 'Lồng đèn', weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	
	
	
	-- [`weapon_trident`]                   = { name = 'weapon_trident', label = 'TRIDENT', weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	-- [`weapon_notzsakura`]                   = { name = 'weapon_notzsakura', label = 'KATANA', weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	-- [`weapon_blackpink`]                   = { name = 'weapon_blackpink', label = 'BLACKPINK', weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	-- [`weapon_fanhand`]                   = { name = 'weapon_fanhand', label = 'FANHAND', weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	-- [`weapon_hammerthor`]                   = { name = 'weapon_hammerthor', label = 'Mjolnir', weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
